...
class EvaluationThresholdTest(unittest.TestCase):
    ...
    def test_fixture_hashes_and_frozen_baseline_are_accepted(self) -> None:
        ...
        results = {
            ...
            "constraint_parsing": {"metrics": {"constraint_exact_match_accuracy": 1.0, "operator_accuracy": 1.0, "clarification_accuracy": 1.0, "structure_accuracy": 1.0, "evidence_state_accuracy": 1.0, "false_eligible_rate": 0.0, "hard_constraint_violation_rate": 0.0, "false_rejection_rate": 0.0}},
