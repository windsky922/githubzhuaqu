...
export function selectPrimaryRecommendation(answer: RagAnswer, candidates: Candidate[]) {
  return !["clarification", "no_match"].includes(answer.answer_mode) && answer.answer_quality?.passed === true && candidates[0]?.eligibility === "eligible"
    ? candidates[0]
    : undefined;
}
