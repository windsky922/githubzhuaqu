...
from src.sender import explorer_url, report_url, runs_url, send_report_to_channels
...
def run_weekly_report(days_back: int | None = None, skip_telegram_send: bool | None = None) -> RunSummary:
    days = _days_back() if days_back is None else days_back
    skip_telegram = _skip_telegram_send() if skip_telegram_send is None else skip_telegram_send
    run_date, since_date = date_range(days)
    ...
    try:
        ...
        summary.telegram_runs_url = runs_url(settings)
